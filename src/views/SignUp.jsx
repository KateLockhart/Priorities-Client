        ...
        <div id="signUpPage">
            ...
            >
                <FormControl >
                    ...
                    <FormControlLabel control={<Checkbox color="success"/>} label="I would like to receive notifications of my priorities." />
                    
                    {/* Notification Preference drop down */}
                    <InputLabel id="notification-select-label">Notification Preference</InputLabel>
                    <Select
